...
let normalize = (s) => JSON.stringify(JSON.parse(s));
describe("roundtrip", () => {
...
describe("tuple", () => {
    it("should match the structure of a JS pyon tuple", () => {
        ...
        tagged.get(tupleArrayKey).forEach((tuple) => {
...
let testNpScalar = (key, dtype, value, preview) => {
...
let linspaceKey = new Fraction(3, 4);
...
let complexKey = new Float64Array([0, 1]);
...
//# sourceMappingURL=pyon.test.js.map