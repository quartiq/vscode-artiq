...
var Tooltip = class extends Module {
  ...
  mousemoveCheck(action, e, component) {
    var tooltip2 = action === "tooltip" ? component.column.definition.tooltip : component.definition.headerTooltip;
    if (tooltip2) {
      this.clearPopup();
      this.timeout = setTimeout(this.loadTooltip.bind(this, e, component, tooltip2), this.table.options.tooltipDelay);
    }
  }
  ...
  loadTooltip(e, component, tooltip2) {
    var contentsEl, renderedCallback, coords;
    function onRendered(callback) {
      renderedCallback = callback;
    }
    if (typeof tooltip2 === "function") {
      tooltip2 = tooltip2(e, component.getComponent(), onRendered);
    }
    if (tooltip2 instanceof HTMLElement) {
      contentsEl = tooltip2;
    } else {
      contentsEl = document.createElement("div");
      if (tooltip2 === true) {
        if (component instanceof Cell) {
          tooltip2 = component.value;
        } else {
          if (component.definition.field) {
            this.langBind("columns|" + component.definition.field, (value) => {
              contentsEl.innerHTML = tooltip2 = value || component.definition.title;
            });
          } else {
            tooltip2 = component.definition.title;
          }
        }
      }
      contentsEl.innerHTML = tooltip2;
    }
    if (tooltip2 || tooltip2 === 0 || tooltip2 === false) {
