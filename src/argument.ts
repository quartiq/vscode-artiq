...
export type Argument<P extends Procdesc> = [ procdesc: P, group: string, tooltip: string, state: State<P> ];
...
export type RowInfo<P extends Procdesc> = { name: Name, arg: Argument<P> };
